...
class MockAppointmentsRepository {
  ...
  async findByDate(date, provider_id) {
    const findAppointment = this.appointments.find(appointment => (0, _dateFns.isEqual)(appointment.date, date) && appointment.id === provider_id);
...
var _default = MockAppointmentsRepository;
